class App {
    ...
    start() {
        ...
        let chosenOption
        do {
            chosenOption = this.showInitialMenu() // Sempre verificar os fehamentos dos metódos.
    ...
    enrollSpaceship() {
        ...
        let crewQuantity = prompt("Qual o número de tripulantes da nave?")
    ...
    askForSpaceshipKind() {                 //Enquanto a escolha não for diferente de 1 e 2, essas opções continuarão aparecendo.
        let chosenOption
